...
const CommunityThreads = () => {
  ...
  const normalize = (text) => {
    return text
      .toLowerCase()
      .replace(/[@!1]/g, "i") // leetspeak i
      .replace(/3/g, "e")
      .replace(/0/g, "o")
      .replace(/4/g, "a")
      .replace(/v/g, "u"); // catch fvck → fuck
  };
  ...
  const addThread = async () => {
    ...
    try {
      ...
      // Profanity check
      if (
        containsProfanity(newThread.title) ||
        containsProfanity(newThread.content) ||
        containsProfanity(newThread.author)
      ) {
        setErrorMessage(
